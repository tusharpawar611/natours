...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidHVzaGFycGF3YXI2MTEiLCJhIjoiY2tkdTRqeHplMDJhdzJxb2gybjFtMjVvayJ9.a6ZImDAOd6i7mZHFoT09qA';
...
var stripe = Stripe('pk_test_51HGktZJz00BkEY36ruq9ICZeu4KN2aHpWdBoKqdRt7boqizesxttX7yTSTKyniKJgVAEkyvTGD17zvLWgzHBHOlX000pAtFTnc');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); //2.create checkout form + charge the card
...
var userPasswordForm = document.querySelector('.password');
